...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			'description' => __( '1. Responsive: the image size determines the banner height. 2) Background image: you can set your preferred height.', 'goya-core' ),
			'value' => array(
				__( 'Responsive Image', 'goya-core' ) => 'fluid',
