...
function goya_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'goya-core',
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v55-jds8w87hk/goya-core.zip',
			'required'           => true,
			'version'            => '1.0.9',
		...
		array(
			...
			'slug'               => 'js_composer',
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v55-jds8w87hk/js_composer.zip',
			'required'           => false,
			'version'            => '8.7.2',
			'force_activation'   => false,
			'force_deactivation' => false,
		...
		array(
			...
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v55-jds8w87hk/wc-ajax-product-filter.zip',
			'required'           => false,
			'version'            => '4.3',
			'force_activation'   => false,
			'force_deactivation' => false,
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => 'https://goya.b-cdn.net/assets/plugins/v55-jds8w87hk/revslider.zip',
			'required'           => false,
			'version'            => '6.7.40',
			'force_activation'   => false,
			'force_deactivation' => false,
