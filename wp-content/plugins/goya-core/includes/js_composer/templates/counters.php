...
function goya_vc_templates_counters($template_list) {
	$template_list['counters_section_01'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/counters/counter-c1.jpg",
		'cat' => array( 'counters' ),
	...
	$template_list['counters_section_02'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/counters/counter-c2.jpg",
		'cat' => array( 'counters' ),
	...
	$template_list['counters_section_03'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/counters/counter-c3.jpg",
		'cat' => array( 'counters' ),
