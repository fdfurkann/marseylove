...
function goya_vc_templates_portfolio($template_list) {
	...
	$template_list['portfolio_01'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/portfolio/portfolio-p1.jpg",
		'cat' => array( 'Portfolio' ),
	...
	$template_list['portfolio_02'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/portfolio/portfolio-p2.jpg",
		'cat' => array( 'Portfolio' ),
	...
	$template_list['portfolio_03'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/portfolio/portfolio-p3.jpg",
		'cat' => array( 'Portfolio' ),
	...
	$template_list['portfolio_04'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/portfolio/portfolio-p4.jpg",
	...
	$template_list['portfolio_05'] = array(
		...
		'thumbnail' => get_template_directory_uri() . "/assets/img/visual-composer/templates/portfolio/portfolio-p5.jpg",
		'cat' => array( 'Portfolio', 'page' ),
