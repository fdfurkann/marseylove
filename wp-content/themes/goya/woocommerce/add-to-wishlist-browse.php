...
global $product;
?>
<div class="yith-wcwl-wishlistexistsbrowse et-tooltip" data-product-id="<?php echo esc_attr( $product_id ); ?>" data-original-product-id="<?php echo esc_attr( $parent_product_id ); ?>">
	<a href="<?php echo esc_url( $wishlist_url ) ?>" rel="nofollow" data-title="<?php echo esc_attr( $browse_wishlist_text ); ?>" aria-label="<?php echo esc_attr( $browse_wishlist_text ); ?>"><span class="text"><?php echo wp_kses_post( apply_filters( 'yith_wcwl_browse_wishlist_label', $browse_wishlist_text, $product_id, $icon ) ); ?></span><span class="icon et-icon et-heart-fill"></span>
	</a>
</div>
