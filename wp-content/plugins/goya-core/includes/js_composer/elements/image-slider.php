...
vc_map( array(
	...
	'params'	=> array(
		...
		array(
			'type' 			=> 'textfield',
			'heading' => __( 'Columns (Desktop)', 'goya-core' ),
			'param_name' => 'columns',
			'description' => __( 'Number of columns to show.', 'goya-core' ),
			'value' 		=> '1',
		),
		array(
			'type' 			=> 'textfield',
			'heading' => __( 'Mobile Columns', 'goya-core' ),
			'param_name' => 'columns_mobile',
			'description' => __( 'Number of columns for mobiles.', 'goya-core' ),
			'value' 		=> '1',
		),
		array(
			'type' => 'dropdown',
