	...
	<?php if ( $login_reminder_at_checkout ) : ?>
		<div id="et-checkout-login-form" class="et-checkout-login">
			<div class="et-checkout-login-title">
				<?php echo apply_filters( 'woocommerce_checkout_login_message', esc_html__( 'Returning customer?', 'woocommerce' ) ); ?> <a href="#" class="showlogin"><?php esc_html_e('Click here to login', 'woocommerce'); ?></a>
			</div>
			<?php
			endif;
